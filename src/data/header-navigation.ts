...
export const navigation: NavigationLink[] = [
    ...
    //     columns: [
    //         {size: 6, items: [
    //             {label: 'Tranformers', url: '/shop/catalog', items: [
    ...
    //         {label: 'Detailed Information',    url: '/account/profile'},
    //         {label: 'Upload Document',    url: '/account/upload'},
    ...
    //         {label: 'Login for Partners',           url: '/account/partner-login'},
    //         {label: 'Register for Partners',           url: '/account/partner-register'}
    //     ]
    // }},
